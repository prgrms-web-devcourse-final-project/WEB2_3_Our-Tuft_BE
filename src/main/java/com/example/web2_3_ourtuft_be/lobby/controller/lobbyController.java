...
public class lobbyController {
    ...
    public ResponseEntity<?> searchRoomById(Long roomId ) {
        ...
        if(room == null) {
            return ResponseEntity.status(HttpStatus.NOT_FOUND).body(NotFoundMessages.ROOM_ID.getMessage());
        }
    ...
    public ResponseEntity<?> searchRoomByName( String roomName ) {
        ...
        if(rooms.isEmpty()) {
            return ResponseEntity.status(HttpStatus.NOT_FOUND).body(NotFoundMessages.ROOM_NAME.getMessage());
        }
