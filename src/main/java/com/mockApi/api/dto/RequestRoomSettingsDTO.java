...
@Setter
@NoArgsConstructor
public class RequestRoomSettingsDTO {
    private long id ;
    ...
    @Builder
    public RequestRoomSettingsDTO(long id, String gameType, String roomName, boolean disclosure, String roomPassword, int peopleEntering, int round, int timeLimit, String host) {
        this.id = id;
