...
public class ProfileResponseDto {
    ...
    public static class Inventory {
        private final List<Integer> hair;
        private final List<Integer> eye;
        private final List<Integer> mouse;
        private final List<Integer> skin;
        private final List<Integer> nickColor;

        public Inventory(List<Integer> hair, List<Integer> eye, List<Integer> mouse, List<Integer> skin, List<Integer> nickColor) {
            this.hair = hair;
            this.eye = eye;
            this.mouse = mouse;
            this.skin = skin;
